...
var itemProperties = [
    ...
    "company.name",
    {
        ...
        render: function (item) {
            return React.createElement(material_1.Chip, { color: 'primary', variant: 'outlined', label: item.name });
        }
    },
    {
        propertyName: "languages",
        render: function (item) {
            return React.createElement(material_1.Chip, { color: 'success', variant: 'outlined', label: item.name });
        }
    },
    {
...
var Advertisements = function () {
    ...
    var headers = ["#", "Title", "Company name", "Positions", "Languages", "Creation date", "Actions"];
    ...
    var deleteAdvertisement = function () {
        if (selectedItemId) {
            setLoading(true);
            api_1.api.advertisement["delete"](selectedItemId)
                .then(function (res) {
                console.log(res);
                setOpen(false);
    ...
    return (React.createElement(system_1.Box, { sx: { width: "100%", overflow: "hidden" } },
        React.createElement(react_helmet_1.Helmet, null,
            React.createElement("title", null, "Job Board | Admin Dashboard | Advertisements")),
        React.createElement(material_1.Dialog, { open: open, onClose: handleClose, "aria-labelledby": 'alert-dialog-title', "aria-describedby": 'alert-dialog-description' },
            ...
            React.createElement(material_1.DialogActions, null,
                ...
                React.createElement(material_1.Button, { disabled: loading, color: 'error', variant: 'outlined', onClick: deleteAdvertisement, autoFocus: true }, "Delete"))),
        ...
        React.createElement(DataTable_1.DataTable, { headers: headers, items: advertisements, itemProperties: itemProperties, actions: actions }),
