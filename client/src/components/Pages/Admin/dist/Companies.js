...
var Companies = function () {
    ...
    var headers = ["#", "Name", "Industry", "Type", "Creation date", "Actions"];
    ...
    var deleteCompany = function () {
        if (selectedItemId) {
            setLoading(true);
            api_1.api.company["delete"](selectedItemId)
                .then(function (res) {
                console.log(res);
                setOpen(false);
    ...
    var actions = [
        {
            ...
            action: function (item) {
                return React.createElement(react_router_1.Redirect, { to: "/admin/company/" + item.id });
            }
        },
        {
            name: "Edit",
    ...
    return (React.createElement(system_1.Box, { sx: { width: "100%", overflow: "hidden" } },
        React.createElement(react_helmet_1.Helmet, null,
            React.createElement("title", null, "Job Board | Admin Dashboard | Companies")),
        React.createElement(material_1.Dialog, { open: open, onClose: handleClose, "aria-labelledby": 'alert-dialog-title', "aria-describedby": 'alert-dialog-description' },
            React.createElement(material_1.DialogTitle, { id: 'alert-dialog-title' }, "Delete this company ?"),
            React.createElement(material_1.DialogActions, null,
                ...
                React.createElement(material_1.Button, { disabled: loading, color: 'error', variant: 'outlined', onClick: deleteCompany, autoFocus: true }, "Delete"))),
        ...
        React.createElement(DataTable_1.DataTable, { headers: headers, items: companies, itemProperties: itemProperties, actions: actions }),
