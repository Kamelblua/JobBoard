...
var Index_styles_1 = require("./styles/Index.styles");
...
var Index = function () {
    var _a;
    var styles = Index_styles_1.useStyles();
    ...
    return (React.createElement(material_1.Box, { component: 'main', className: styles.container }, company && !loading && (React.createElement(material_1.Box, { className: styles.stack },
        React.createElement(react_helmet_1.Helmet, null,
            React.createElement("title", null,
                "Job Board | ",
                company.name)),
        React.createElement(material_1.Box, { component: 'section', className: styles.infos },
            React.createElement(material_1.Avatar, { className: styles.logo, src: (_a = company === null || company === void 0 ? void 0 : company.logo) === null || _a === void 0 ? void 0 : _a.location, alt: (company === null || company === void 0 ? void 0 : company.name) + "'s logo" }),
