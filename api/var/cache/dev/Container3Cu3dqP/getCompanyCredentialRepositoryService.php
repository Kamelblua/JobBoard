 ...
 */
class getCompanyCredentialRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\CompanyCredentialRepository' shared autowired service.
     *
     * @return \App\Repository\CompanyCredentialRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'CompanyCredentialRepository.php';

        return $container->privates['App\\Repository\\CompanyCredentialRepository'] = new \App\Repository\CompanyCredentialRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
