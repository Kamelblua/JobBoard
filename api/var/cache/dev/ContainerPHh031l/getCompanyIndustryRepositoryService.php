 ...
 */
class getCompanyIndustryRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\CompanyIndustryRepository' shared autowired service.
     *
     * @return \App\Repository\CompanyIndustryRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'CompanyIndustryRepository.php';

        return $container->privates['App\\Repository\\CompanyIndustryRepository'] = new \App\Repository\CompanyIndustryRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
