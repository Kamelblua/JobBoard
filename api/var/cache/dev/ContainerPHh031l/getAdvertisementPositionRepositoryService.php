 ...
 */
class getAdvertisementPositionRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\AdvertisementPositionRepository' shared autowired service.
     *
     * @return \App\Repository\AdvertisementPositionRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'AdvertisementPositionRepository.php';

        return $container->privates['App\\Repository\\AdvertisementPositionRepository'] = new \App\Repository\AdvertisementPositionRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
