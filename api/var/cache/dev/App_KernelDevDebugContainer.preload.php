...
require __DIR__.'/Container3Cu3dqP/App_KernelDevDebugContainer.php';
require __DIR__.'/Container3Cu3dqP/PaginatorInterface_82dac15.php';
require __DIR__.'/Container3Cu3dqP/EntityManager_9a5be93.php';
require __DIR__.'/Container3Cu3dqP/getValidator_NotCompromisedPasswordService.php';
require __DIR__.'/Container3Cu3dqP/getValidator_ExpressionService.php';
require __DIR__.'/Container3Cu3dqP/getValidator_EmailService.php';
require __DIR__.'/Container3Cu3dqP/getTwig_Runtime_SerializerService.php';
require __DIR__.'/Container3Cu3dqP/getTwig_Runtime_SecurityCsrfService.php';
require __DIR__.'/Container3Cu3dqP/getTwig_Runtime_HttpkernelService.php';
require __DIR__.'/Container3Cu3dqP/getTranslation_Loader_YmlService.php';
require __DIR__.'/Container3Cu3dqP/getTranslation_Loader_XliffService.php';
require __DIR__.'/Container3Cu3dqP/getTranslation_Loader_ResService.php';
require __DIR__.'/Container3Cu3dqP/getTranslation_Loader_QtService.php';
require __DIR__.'/Container3Cu3dqP/getTranslation_Loader_PoService.php';
require __DIR__.'/Container3Cu3dqP/getTranslation_Loader_PhpService.php';
require __DIR__.'/Container3Cu3dqP/getTranslation_Loader_MoService.php';
require __DIR__.'/Container3Cu3dqP/getTranslation_Loader_JsonService.php';
require __DIR__.'/Container3Cu3dqP/getTranslation_Loader_IniService.php';
require __DIR__.'/Container3Cu3dqP/getTranslation_Loader_DatService.php';
require __DIR__.'/Container3Cu3dqP/getTranslation_Loader_CsvService.php';
require __DIR__.'/Container3Cu3dqP/getSessionService.php';
require __DIR__.'/Container3Cu3dqP/getServicesResetterService.php';
require __DIR__.'/Container3Cu3dqP/getSecurity_Validator_UserPasswordService.php';
require __DIR__.'/Container3Cu3dqP/getSecurity_User_Provider_Concrete_AppUserProviderService.php';
require __DIR__.'/Container3Cu3dqP/getSecurity_PasswordHasherFactoryService.php';
require __DIR__.'/Container3Cu3dqP/getSecurity_Logout_Listener_CsrfTokenClearingService.php';
require __DIR__.'/Container3Cu3dqP/getSecurity_Listener_UserProviderService.php';
require __DIR__.'/Container3Cu3dqP/getSecurity_Listener_UserChecker_MainService.php';
require __DIR__.'/Container3Cu3dqP/getSecurity_Listener_Session_MainService.php';
require __DIR__.'/Container3Cu3dqP/getSecurity_Listener_PasswordMigratingService.php';
require __DIR__.'/Container3Cu3dqP/getSecurity_Listener_Main_UserProviderService.php';
require __DIR__.'/Container3Cu3dqP/getSecurity_Listener_CsrfProtectionService.php';
require __DIR__.'/Container3Cu3dqP/getSecurity_Listener_CheckAuthenticatorCredentialsService.php';
require __DIR__.'/Container3Cu3dqP/getSecurity_Firewall_Map_Context_MainService.php';
require __DIR__.'/Container3Cu3dqP/getSecurity_Firewall_Map_Context_DevService.php';
require __DIR__.'/Container3Cu3dqP/getSecurity_Firewall_Authenticator_MainService.php';
require __DIR__.'/Container3Cu3dqP/getSecurity_Csrf_TokenStorageService.php';
require __DIR__.'/Container3Cu3dqP/getSecurity_ChannelListenerService.php';
require __DIR__.'/Container3Cu3dqP/getSecurity_AccessListenerService.php';
require __DIR__.'/Container3Cu3dqP/getSecrets_VaultService.php';
require __DIR__.'/Container3Cu3dqP/getRouting_LoaderService.php';
require __DIR__.'/Container3Cu3dqP/getPropertyInfo_SerializerExtractorService.php';
require __DIR__.'/Container3Cu3dqP/getKnpPaginatorService.php';
require __DIR__.'/Container3Cu3dqP/getFragment_Renderer_InlineService.php';
require __DIR__.'/Container3Cu3dqP/getErrorControllerService.php';
require __DIR__.'/Container3Cu3dqP/getDoctrine_UuidGeneratorService.php';
require __DIR__.'/Container3Cu3dqP/getDoctrine_UlidGeneratorService.php';
require __DIR__.'/Container3Cu3dqP/getDoctrine_Orm_Validator_UniqueService.php';
require __DIR__.'/Container3Cu3dqP/getDoctrine_Orm_Listeners_PdoCacheAdapterDoctrineSchemaSubscriberService.php';
require __DIR__.'/Container3Cu3dqP/getDoctrine_Orm_Listeners_DoctrineTokenProviderSchemaSubscriberService.php';
require __DIR__.'/Container3Cu3dqP/getDoctrine_Orm_DefaultListeners_AttachEntityListenersService.php';
require __DIR__.'/Container3Cu3dqP/getDoctrine_Orm_DefaultEntityManager_PropertyInfoExtractorService.php';
require __DIR__.'/Container3Cu3dqP/getDebug_Security_Voter_VoteListenerService.php';
require __DIR__.'/Container3Cu3dqP/getDebug_Security_Voter_Security_Access_SimpleRoleVoterService.php';
require __DIR__.'/Container3Cu3dqP/getDebug_Security_Voter_Security_Access_ExpressionVoterService.php';
require __DIR__.'/Container3Cu3dqP/getDebug_Security_Voter_Security_Access_AuthenticatedVoterService.php';
require __DIR__.'/Container3Cu3dqP/getDebug_Security_UserValueResolverService.php';
require __DIR__.'/Container3Cu3dqP/getDebug_ArgumentResolver_VariadicService.php';
require __DIR__.'/Container3Cu3dqP/getDebug_ArgumentResolver_SessionService.php';
require __DIR__.'/Container3Cu3dqP/getDebug_ArgumentResolver_ServiceService.php';
require __DIR__.'/Container3Cu3dqP/getDebug_ArgumentResolver_RequestAttributeService.php';
require __DIR__.'/Container3Cu3dqP/getDebug_ArgumentResolver_RequestService.php';
require __DIR__.'/Container3Cu3dqP/getDebug_ArgumentResolver_NotTaggedControllerService.php';
require __DIR__.'/Container3Cu3dqP/getDebug_ArgumentResolver_DefaultService.php';
require __DIR__.'/Container3Cu3dqP/getContainer_GetenvService.php';
require __DIR__.'/Container3Cu3dqP/getContainer_EnvVarProcessorsLocatorService.php';
require __DIR__.'/Container3Cu3dqP/getContainer_EnvVarProcessorService.php';
require __DIR__.'/Container3Cu3dqP/getCache_ValidatorExpressionLanguageService.php';
require __DIR__.'/Container3Cu3dqP/getCache_SystemClearerService.php';
require __DIR__.'/Container3Cu3dqP/getCache_SystemService.php';
require __DIR__.'/Container3Cu3dqP/getCache_GlobalClearerService.php';
require __DIR__.'/Container3Cu3dqP/getCache_AppClearerService.php';
require __DIR__.'/Container3Cu3dqP/getCache_AppService.php';
require __DIR__.'/Container3Cu3dqP/getApiPlatform_SwaggerUi_ActionService.php';
require __DIR__.'/Container3Cu3dqP/getApiPlatform_Swagger_Action_UiService.php';
require __DIR__.'/Container3Cu3dqP/getApiPlatform_Openapi_OptionsService.php';
require __DIR__.'/Container3Cu3dqP/getApiPlatform_Openapi_FactoryService.php';
require __DIR__.'/Container3Cu3dqP/getApiPlatform_Metadata_PropertySchema_OneOfRestrictionService.php';
require __DIR__.'/Container3Cu3dqP/getApiPlatform_Listener_View_WriteService.php';
require __DIR__.'/Container3Cu3dqP/getApiPlatform_Listener_View_ValidateService.php';
require __DIR__.'/Container3Cu3dqP/getApiPlatform_Listener_View_SerializeService.php';
require __DIR__.'/Container3Cu3dqP/getApiPlatform_Listener_View_RespondService.php';
require __DIR__.'/Container3Cu3dqP/getApiPlatform_Listener_Exception_ValidationService.php';
require __DIR__.'/Container3Cu3dqP/getApiPlatform_Listener_ExceptionService.php';
require __DIR__.'/Container3Cu3dqP/getApiPlatform_Jsonld_Action_ContextService.php';
require __DIR__.'/Container3Cu3dqP/getApiPlatform_Doctrine_Orm_QueryExtension_PaginationService.php';
require __DIR__.'/Container3Cu3dqP/getApiPlatform_Doctrine_Orm_QueryExtension_OrderService.php';
require __DIR__.'/Container3Cu3dqP/getApiPlatform_Doctrine_Orm_QueryExtension_FilterEagerLoadingService.php';
require __DIR__.'/Container3Cu3dqP/getApiPlatform_Doctrine_Orm_QueryExtension_FilterService.php';
require __DIR__.'/Container3Cu3dqP/getApiPlatform_Doctrine_Orm_QueryExtension_EagerLoadingService.php';
require __DIR__.'/Container3Cu3dqP/getApiPlatform_Doctrine_Orm_Default_SubresourceDataProviderService.php';
require __DIR__.'/Container3Cu3dqP/getApiPlatform_Doctrine_Orm_Default_ItemDataProviderService.php';
require __DIR__.'/Container3Cu3dqP/getApiPlatform_Doctrine_Orm_Default_CollectionDataProviderService.php';
require __DIR__.'/Container3Cu3dqP/getApiPlatform_Doctrine_Orm_DataPersisterService.php';
require __DIR__.'/Container3Cu3dqP/getApiPlatform_Action_PlaceholderService.php';
require __DIR__.'/Container3Cu3dqP/getApiPlatform_Action_NotFoundService.php';
require __DIR__.'/Container3Cu3dqP/getApiPlatform_Action_ExceptionService.php';
require __DIR__.'/Container3Cu3dqP/getApiPlatform_Action_EntrypointService.php';
require __DIR__.'/Container3Cu3dqP/getApiPlatform_Action_DocumentationService.php';
require __DIR__.'/Container3Cu3dqP/getTemplateControllerService.php';
require __DIR__.'/Container3Cu3dqP/getRedirectControllerService.php';
require __DIR__.'/Container3Cu3dqP/getJobApplicationRepositoryService.php';
require __DIR__.'/Container3Cu3dqP/getFileRepositoryService.php';
require __DIR__.'/Container3Cu3dqP/getCompanyTypeRepositoryService.php';
require __DIR__.'/Container3Cu3dqP/getCompanyRepositoryService.php';
require __DIR__.'/Container3Cu3dqP/getCompanyIndustryRepositoryService.php';
require __DIR__.'/Container3Cu3dqP/getCompanyCredentialRepositoryService.php';
require __DIR__.'/Container3Cu3dqP/getCandidateRepositoryService.php';
require __DIR__.'/Container3Cu3dqP/getAdvertisementRepositoryService.php';
require __DIR__.'/Container3Cu3dqP/getAdvertisementPositionRepositoryService.php';
require __DIR__.'/Container3Cu3dqP/getAdvertisementControllerService.php';
require __DIR__.'/Container3Cu3dqP/get_Session_DeprecatedService.php';
require __DIR__.'/Container3Cu3dqP/get_ServiceLocator_KfwZsneService.php';
require __DIR__.'/Container3Cu3dqP/get_ServiceLocator_KfbR3DYService.php';
require __DIR__.'/Container3Cu3dqP/get_ServiceLocator_9wplPMAService.php';
require __DIR__.'/Container3Cu3dqP/get_ServiceLocator_3J8poMService.php';
require __DIR__.'/Container3Cu3dqP/get_Container_Private_TwigService.php';
require __DIR__.'/Container3Cu3dqP/get_Container_Private_Security_Csrf_TokenManagerService.php';
require __DIR__.'/Container3Cu3dqP/get_Container_Private_FilesystemService.php';
require __DIR__.'/Container3Cu3dqP/get_Container_Private_CacheClearerService.php';
...
$classes[] = 'App\Repository\AdvertisementPositionRepository';
$classes[] = 'App\Repository\AdvertisementRepository';
$classes[] = 'App\Repository\CandidateRepository';
$classes[] = 'App\Repository\CompanyCredentialRepository';
$classes[] = 'App\Repository\CompanyIndustryRepository';
